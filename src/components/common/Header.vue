      ...
      <el-form ref="addForm" :model="addForm" :rules="carFormRules" label-width="100px">
        <el-form-item label="姓名：">
         ...
         <el-form-item label="用户名：">
          <el-input placeholder="请输入用户名" v-model="username" class="icon-nd-input"></el-input>
        </el-form-item>
      ...
      if(this.username&&this.addForm.passward){
        if(this.addForm.passward==this.addForm.passwarder){
           this.hide = false;
            var res = this;
            this.$axios({
              url: "testBoot/updatePassword",
              method: "post",
              data: { passWord: res.addForm.passward, userName: res.username ,realName:res.realName}
            })
