    ...
    <div class="header">
        ...
        <div class="header-right">
         ...
         <el-dialog align="center" title="修改密码" :visible.sync="hide" width="30%">
            <p> <el-input placeholder="请输入用户名" v-model="input1" class="icon-nd-input"></el-input></p>
            <p><el-input placeholder="请输入要修改的密码" v-model="input1" class="icon-nd-input"></el-input></p> 
