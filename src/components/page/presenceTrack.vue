  ...
  <div class="carManager">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i> 在场轨迹表
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="ptCreatTime" label="时间" align="center"   class-name="table"></el-table-column>
        <el-table-column prop="ptLincensePlateId" label="车牌号" align="center"  class-name="table"></el-table-column>
        <el-table-column prop="jcName" label="摄像机"  align="center" class-name="table"></el-table-column>
        <el-table-column prop="ptStatus" label="轨迹信息"  align="center" class-name="table"></el-table-column>
      </el-table>
...
      this.$axios({
        url: 'jinshiPresenceTrack/selectPresenceTrackAll',
        method: "post",
        data: {
...
          res.tableData=[]
          for(var i=0;i<response.data.PresenceTrackData.length;i++){
                let date = new Date(response.data.PresenceTrackData[i].ptCreatTime);
                ...
                response.data.PresenceTrackData[i].ptCreatTime=tempDate
          }
          res.tableData = response.data.PresenceTrackData                                                                                                                                                                                                                                                                                                      
          res.totalRecords=response.data.PresenceTrackRecords
        })
...
    }, 
    ...
    //     var res = this;
    //     this.$axios({
    //         url: "jinshiPresenceTrack/searchPresenceTrack",
    //         method: "post",
    ...
    onsearch(value){
      if(value==1){
        ...
        console.log(window.localStorage.getItem("parkId"))
        this.$axios({
            url: "jinshiPresenceTrack/selectPresenceTrackByTime",
            method: "post",
