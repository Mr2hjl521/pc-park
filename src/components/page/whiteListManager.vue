  ...
  <div class="whiteListManager">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i> 黑/白名单
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="listType" label="类型" class-name="table"></el-table-column>
        <el-table-column prop="describtion" label="描述" class-name="table"></el-table-column>
        <el-table-column
          prop="create_time"
    ...
    <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
      <el-form ref="editForm" :model="editForm" label-width="100px" :rules="carFormRules">
        ...
        <el-form-item label="描述" prop="describtion">
          <el-input v-model="editForm.describtion" placeholder="请添加描述"></el-input>
        </el-form-item>
      </el-form>
